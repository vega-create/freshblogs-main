---
title: "12 Tarot Spreads for Every Situation: From Daily Pulls to Deep Dives"
description: "Learn 12 tarot spreads with card positions, layouts, and example interpretations. Covers daily pulls, Celtic Cross, relationship, career, and shadow work spreads."
publishDate: 2026-03-19
updatedDate: 2026-03-19
author: "luna"
category: "spreads"
tags: ["tarot spreads", "celtic cross", "tarot layouts", "relationship spread", "career tarot"]
faq:
...
Shuffle while asking "What do I need to know today?" and draw a single card. This is the foundational practice for every tarot reader regardless of experience level.
...
**Position 1:** Past — what led to the current situation. **Position 2:** Present — the dominant energy right now. **Position 3:** Future — the likely outcome on the current path.
...
**Position 1:** The present situation — the core issue or central theme. **Position 2:** The crossing card — the immediate challenge or obstacle (laid horizontally across card 1). **Position 3:** The crown — your conscious goal or best possible outcome in this situation. **Position 4:** The foundation — the subconscious root or underlying cause. **Position 5:** The recent past — events or influences just passing. **Position 6:** The near future — what is approaching in the coming weeks. **Position 7:** Your attitude — how you see yourself in this situation. **Position 8:** External influences — how others and the environment affect you. **Position 9:** Hopes and fears — what you most want or most dread (often the same thing). **Position 10:** The outcome — the final result based on all other factors.
...
**Positions 1–12:** Each card represents one month of the coming year, from the current month forward.

Draw twelve cards and lay them in a clockwise circle. Each card reveals the dominant theme or energy for that month. Read them individually first, then look for patterns — clusters of the same suit, repeated numbers, or a Major Arcana card marking a pivotal month.
...
**Position 1:** The seed — your core intention for this lunar cycle. **Position 2:** The soil — what foundation or resources support this intention. **Position 3:** What to release — an old pattern or belief that blocks growth. **Position 4:** What to nurture — the action or attitude to cultivate. **Position 5:** The potential harvest — what this intention could become by the full moon.
...
**Positions 1–7:** Each card represents one day of the week, from Monday through Sunday.
...
Avoid using a ten-card spread for a simple question — the extra positions will not add clarity, they will add noise. Similarly, do not try to squeeze a complex life question into a single card pull and then wonder why the answer feels incomplete.
...
- Biddy Tarot. "[Tarot Spreads](https://www.biddytarot.com/tarot-spreads/)."
- Labyrinthos. "[Tarot Spreads for Beginners](https://labyrinthos.co/blogs/learn-tarot-with-labyrinthos-academy)."
